...
- Add a button in each VARIATION list item in the VARIATIONS section of the slide-out drawer that can generate an AI prompt that specifies all the parameters and values of the Variation in question.

- The AI Prompt text generated will appear in a pop-up modal with further options to COPY TEXT or DOWNLOAD AS .MD
